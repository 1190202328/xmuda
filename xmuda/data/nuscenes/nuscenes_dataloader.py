...
class NuScenesBase(Dataset):
    ...
    def __init__(self,
        ...
        if pselab_paths:
            ...
            pseudo_label_2d = np.concatenate([data['pseudo_label_2d'] for data in self.pselab_data]).astype(np.int_)
            ...
            if 'probs_3d' in self.pselab_data[0].keys():
                ...
                pseudo_label_3d = np.concatenate([data['pseudo_label_3d'] for data in self.pselab_data]).astype(np.int_)
